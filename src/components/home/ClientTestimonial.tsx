import { ChevronLeft, ChevronRight, Star, User2 } from 'lucide-react';
        ...
        <div className="flex justify-between">
          ...
          <div className="flex space-x-2">
            {testimonials.map((_, index) => (
              <button
                key={index}
                className={`w-3 h-3 rounded-full transition-colors ${index === activeIndex ? 'bg-amber-600' : 'bg-gray-300'
                  }`}
